...
SAMPLE_ZIP = {
    ...
    '2011n': _full_path('15_min_counts_2011_neg_sample.zip'),
    '2011p': _full_path('15_min_counts_2011_pos_sample.zip'),
    '2012': _full_path('15_min_counts_2012_neg_sample.zip')}
"""Sample zip of 15-minute bin count files from 2010, 2011 (negative and
positive) and 2012."""
