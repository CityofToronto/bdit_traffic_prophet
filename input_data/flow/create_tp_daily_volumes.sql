...
-- DROP MATERIALIZED VIEW prj_volume.tp_daily_volumes;
...
ALTER TABLE prj_volume.tp_daily_volumes
    OWNER TO prj_volume_admins;

COMMENT ON MATERIALIZED VIEW prj_volume.tp_daily_volumes
...
GRANT SELECT ON TABLE prj_volume.tp_daily_volumes TO bdit_humans;